...
## week_5
+ HW 5
  + TF-IDF：管中閔 - 分析管中閔遴選爭議爆發以來的臉書貼文內容，經文字處理後，計算 TF-IDF 做近一步的分析。
...
## project_1
+ project_1
  + TF-IDF + Visualization - Visualizing the bigrams with the top 10 TF-IDF weights in each book from the ASoIaF series.
